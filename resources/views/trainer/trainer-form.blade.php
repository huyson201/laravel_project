                                ...
                                <div class="card-body">
                                    <form action="{{ route('trainer.custom.edit') }}" method="POST">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" placeholder="Trainer's name..." id="name"
                                                class="form-control" name="trainer_name"
                                                value="{{ $trainer->trainer_name }}" required autofocus>
                                            @error('trainer_name')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" placeholder="Trainer's phone..." id="phone"
                                                class="form-control" name="trainer_phone"
                                                value="{{ $trainer->trainer_phone }}" required autofocus>
                                            @error('trainer_phone')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" placeholder="Trainer's address" id="address"
                                                class="form-control" name="trainer_address"
                                                value="{{ $trainer->trainer_address }}" required autofocus>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('trainer.custom.create') }}" method="GET">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="name">Name</label>
                                            <input type="text" placeholder="Trainer's name..." id="name"
                                                class="form-control" name="trainer_name" required autofocus>
                                            @error('trainer_name')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="phone">Phone</label>
                                            <input type="text" placeholder="Trainer's phone..." id="phone"
                                                class="form-control" name="trainer_phone" required>
                                            @error('trainer_phone')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="address">Address</label>
                                            <input type="text" placeholder="Trainer's address..." id="address"
                                                class="form-control" name="trainer_address" required>
                                            @error('trainer_address')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
